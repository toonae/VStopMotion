...
public class VdostopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vdostop);

        final  VideoView myVideoV = (VideoView)findViewById(R.id.vdo);
